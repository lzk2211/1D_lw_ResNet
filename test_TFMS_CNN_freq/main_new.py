...
def main():
    ...
    parser.add_argument('--model', type=str, default='TFMS_CNN_freq', help='switch model')
    parser.add_argument('--image_path', type=str, default='/root/autodl-tmp/lzk/D00/data_set_1024_1024', help='dataset path')
    ...
    if args.Train:
        ...
        for epoch in range(epochs):
            ...
            for step, data in enumerate(train_bar):
                ...
                optimizer.zero_grad()
                outputs = model(freq_seq.to(device))
